...
class PoseDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        nm_in = normalSpeed.depth_normal(depth.astype(np.uint16), self.cam_fx, self.cam_fy, k_size, distance_threshold, difference_threshold, True)
        ...
        if self.mode == 'eval':
            my_mask = np.stack((label,label,label), axis = -1)
